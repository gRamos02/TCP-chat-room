...
class Ui_ChatForm(object):
    def setupUi(self, ChatForm):
        ...
        ChatForm.setMaximumSize(QSize(549, 535))
        ...
        sizePolicy1.setHeightForWidth(self.msg_output.sizePolicy().hasHeightForWidth())
        self.msg_output.setSizePolicy(sizePolicy1)
        self.msg_output.setMaximumSize(QSize(545, 535))
        font2 = QFont()
        font2.setPointSize(18)
        font2.setBold(True)
        self.msg_output.setFont(font2)
        self.msg_output.setStyleSheet(u"background-color: #f9f5d7; color: #282828;")
        self.msg_output.setLineWrapMode(QTextEdit.NoWrap)
        ...
        sizePolicy2.setHeightForWidth(self.msg_input.sizePolicy().hasHeightForWidth())
        self.msg_input.setSizePolicy(sizePolicy2)
        font3 = QFont()
